...
################################################################################
################################################################################
plot_optimizer_rms_grid <- function(file.txt, repr_plot_width=16, repr_plot_height=4, repr_plot_res=250) {
...
################################################################################
################################################################################
plot_optimizer_adam_grid <- function(file.txt, repr_plot_width=16, repr_plot_height=4, repr_plot_res=250) {
